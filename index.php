			...
			<nav class="navbar navbar-expand-lg navbar-light justify-content-center">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="menu_selection">
						<li><a href="signup.php"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
			...
			<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
				...
				<nav id="colorlib-main-menu" role="navigation">
					<ul>
						...
						<ul id="cat1">
							<li class="catt1"><a href="frames.php">Frames & Paintings</a></li>
							<li class="catt1"><a href="wclk.php" >Wall clock</a></li>
							<li class="catt1"><a href="wart.php">Wall Art</a></li>
